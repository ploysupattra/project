  ...
  <body>
    <div class="container">
      ...
      <div class="row" style="padding-top:120px;">
        <center><p>แก้ไขบัญชีผู้ใช้</p></center>
      </div><br /><br />
      <!-- Body -->
      <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-8">
          <form action="<?php echo base_url(); ?>conuser/update" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <a href="<?php echo base_url();?>conuser/profile" type="button" class="btn btn-info">ยกเลิกการแก้ไข</a></center>
          </div>
        </form>
        </div>
      </div>
