...
<html>
  ...
  <body>
    <div class="login-page">
      <div class="form">
        <form class="login-form" action=" <?php echo base_url();?>conuser/mylogin" method="post"
          enctype="multipart/form-data">
          <h3>Login เข้าบัญชีสมาชิก</h3><br />
          <input type="text" placeholder="Username" name="username"/>
          <input type="password" placeholder="Password" name="password"/>
          <button>login</button>
          <p class="message"><a href="<?php echo base_url(); ?>lobby/web">Home</a>/<a href="<?php echo base_url(); ?>conuser/regis_user">สมัครสมาชิก</a></p>
        </form>
      </div>
    </div>
  </body>
