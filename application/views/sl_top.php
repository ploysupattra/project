  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="col-md-8">
          <?php foreach($general->result() as $row) { ?>
            <div class="row">
              ...
              <form action="<?php echo base_url(); ?>lobby/sd_lobby" method="post" >
                <div class="col-md-8 col-xs-4">
                  ...
                  <button class="btn btn-danger" value="<?php echo $row->shop_id;?>" type="submit" name="showgen" >ดูรายละเอียด</button>
                </div>
              </form>
            </div><br /><br />
            <?php  } ?>
        ...
        <div class="col-md-4">
          ...
          <img  class="img-responsive" src="<?php echo base_url(); ?>../assets/img/banner/carside.jpg"/>
        </div>
			</div>
      <footer>
