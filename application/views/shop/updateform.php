...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-8">
          <div class="row">
            <form action="<?php echo base_url(); ?>conshop/update" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="row">
                <center><button type="submit" name="shop_id" value="<?php echo $row->shop_id; ?>" class="btn btn-info" >ยืนยันการแก้ไข</button>
                        ...
                        <a href="<?php echo base_url(); ?>conshop/shop"><button class="btn btn-info" >ยกเลิกการแก้ไข</button></a>
                </center>
              </div>
