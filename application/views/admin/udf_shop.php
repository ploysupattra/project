...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-8">
          <div class="row">
            <form action="<?php echo base_url(); ?>conadmin/udshop" method="post" enctype="multipart/form-data">
              <?php foreach ($shop_member->result() as $row) { ?>
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="callphone" value="<?php echo $row->callphone; ?>">
              </div>
              <div class="col-md-6">
...
<!-- _____________________________________ส่วนปัก Location________________________________ -->
            <div class="row">
                ...
                <script async defer
                  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAJb6ASr8pWUF4uMoxT9Oujreq-fmGXljs&callback=initMap">
                </script>
              </div><br />
              <div class="form-inline">
                <?php foreach ($shop_member->result() as $row) {?>
                  <center><label>Latitude :  </label>
                  <input type="text" class="form-control" id="latitude" name="lat" value="<?php echo $row->latitude; ?>" />
                  <label>Longtitude :  </label>
                  <input type="text" class="form-control" id="longtitude" name="lng" value="<?php echo $row->longtitude; ?>" /></center>
                  <?php } ?>
              </div>
              <div class="row">
                <center><button type="submit" name="shop_id" value="<?php echo $row->shop_id; ?>" class="btn btn-info" >ยืนยันการแก้ไข</button>
                </form>
                        <a href="<?php echo base_url(); ?>conadmin/shop"><button class="btn btn-info" >ยกเลิกการแก้ไข</button></a>
                </center>
              </div>
