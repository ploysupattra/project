  ...
  <body>
      ...
      <div class="row" style="padding-top:80px;">
        <div class="container">
          ...
          <div class="col-md-8">
            <center><p class="titleh" style="font-size:55px;">เพิ่มงานเกี่ยวกับมอเตอร์ไซต์</p></center><br />
              <form action="<?php echo base_url(); ?>conadmin/addevent" method="post" enctype="multipart/form-data">
                <div class="form-inline">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="row">
                        ชื่องาน : <input class="form-control" type="text" name="eventname"  />
                      </div><br />
                      <div class="row">
                        วันที่เริ่มกิจกรรม : <input type="date" class="form-control"  name="start">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row">
                      ...
                      <div class="row">
                        วันที่ปิดกิจกรรม : <input type="date" class="form-control"  name="end">
                      </div>
                    </div>
                  </div><br />
                  <div class="row">
                    รายละเอียดกิจกรรม : <textarea style="width:450px;" rows="5" class="form-control" name="detail"></textarea>
                  </div><br />
                  <div class="row">
                    Link กิจกรรม : <input class="form-control" type="text" name="link" width="auto" />
                  </div>
                  <center><button class="btn btn-success" type="submit">เพิ่มกิจกรรม</button></center>
                </div>
              </form>
          </div>
          <div class="col-md-2">
